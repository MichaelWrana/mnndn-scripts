...
if __name__ == '__main__':
    ...
    topo_file = f'{experiment_dir}/topologies/ba-topo-poor.conf' # Mininet topology file directory
    ...
    temp_topo_file = perturb_link_delays(topo_file, min_delta=0, max_delta=9)
