...
# If the FD is delayed (e.g., due to tcpdump), this can block the I/O path.
...
# sometimes not required at all, even for ANDaNA, may depend on operating system, hardware, and kernel config
